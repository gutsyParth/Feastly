  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6 space-y-6">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
        ...
        <button
          onClick={checkout}
          className={`mt-3 w-full rounded-lg bg-[#E23774] py-3 text-sm font-semibold text-white hover:bg-red-800 ${
            !restaurant.isOpen ? "opacity-50" : ""
          }`}
        ...
        <button
          onClick={clearCart}
          className="mt-3 w-full rounded-lg bg-[#7b7979] py-3 text-sm font-semibold text-white hover:bg-gray-500 flex justify-center items-center gap-3"
